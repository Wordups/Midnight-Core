...
tier split, repriced 2026-08-14 against the GRC market (Vanta/Drata/Sprinto
entry contracts run $5-15k/yr; self-serve stays the wedge but not at a
signal-destroying 90% discount): free (1 watermarked generation, preview only)
/ starter $49 (one framework, 10 docs a month) / pro $199 (everything mapped,
full gap list) / team $499 (10 seats, SME workflow at scale) / enterprise
(contact-only, no self-serve checkout).
